...
ALLOWED_HOSTS = ['py5.aegis-info.com','police.helper.aegis-info.com','192.168.11.88','192.168.11.183','127.0.0.1']
...
LANGUAGE_CODE = 'zh-hans' # 修改使用中文界面
